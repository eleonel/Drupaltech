...
<div class="media-stream-container">
  ...
  <?php
  // check for media format (if any)
  if (isset($fields['field_video_url_embed'])) {
    print $fields['field_video_url_embed']->content;
  }
  elseif (isset($fields['field_audio_embed'])) {
    $audio_iframe = str_replace('width="425" height="166"', 'width="200" height="200"', $fields['field_audio_embed']->content);
    print $audio_iframe;
  }
  elseif (isset($fields['field_exhibit_uimage_fid_1'])) {
