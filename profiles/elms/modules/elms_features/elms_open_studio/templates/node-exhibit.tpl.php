  ...
  <div class="media-stream-content">
    ...
    <?php
      ...
      if ($node->uid == $user->uid) {
        print 'Add exhibit: '. l('Image','node/add/exhibit-image',array('query' => 'destination=node/'. $node->nid .'&edit[field_exhibit_reference][nid][nid]='. $node->nid, 'attributes' => array('class' => 'add-image-link'))) .', '. l('Audio','node/add/exhibit-audio',array('query' => 'destination=node/'. $node->nid .'&edit[field_exhibit_reference][nid][nid]='. $node->nid, 'attributes' => array('class' => 'add-image-link'))) .', '. l('Video','node/add/exhibit-video',array('query' => 'destination=node/'. $node->nid .'&edit[field_exhibit_reference][nid][nid]='. $node->nid, 'attributes' => array('class' => 'add-image-link'))) .', '. l('Post','node/add/exhibit-post',array('query' => 'destination=node/'. $node->nid .'&edit[field_exhibit_reference][nid][nid]='. $node->nid, 'attributes' => array('class' => 'add-image-link'))) .', '. l('Post (via RSS)','import/blog_posts',array('query' => 'destination=node/'. $node->nid .'&field_exhibit_reference='. $node->nid, 'attributes' => array('class' => 'add-image-link')));
      }
    ?>
      </div>
  </div>
